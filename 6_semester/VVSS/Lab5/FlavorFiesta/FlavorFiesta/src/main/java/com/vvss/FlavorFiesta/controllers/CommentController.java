...
import com.vvss.FlavorFiesta.payloads.request.NewCommentDTO;
...
public class CommentController {
    ...
    @PostMapping("/")
    public Comment addComment(@RequestBody NewCommentDTO newComment) {
        Recipe recipe = recipeService.getRecipeById(newComment.getRecipeId());
        User user = ownershipUtil.getCurrentUser();

        Comment comment = new Comment(recipe, user, newComment.getContent());
