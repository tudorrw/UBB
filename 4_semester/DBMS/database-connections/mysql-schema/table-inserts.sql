...
INSERT INTO `music-festivals`.tickets (id, festivalId, userId, typeId, paymentMethodId, quantity ,PurchaseDate)
VALUES
    (1, 3, 1, 1, 1, 4, '2022-11-20'),
    (2, 4, 3, 2, 2, 6, '2023-03-01'),
    (3, 4, 4, 1, 1, 1, '2023-05-25'),
    (4, 2, 3, 3, 3, 2, '2018-04-21');


Insert into `music-festivals`.festivalsTicketsPrices (festivalId, ticketTypeId, price)
values
    (4, 1, 180),
    (4, 2, 240),
    (4, 3, 90),
...
INSERT INTO `music-festivals`.tickets (id, festivalId, userId, typeId, paymentMethodId, quantity ,PurchaseDate)
VALUES
    (1, 3, 'General Access', 355.50, '2022-11-20', 'Tudor', 'Credit Card'),
    (2, 4, 'VIP Access', 140.00, '2023-03-01', 'Raul', 'PayPal'),
    (3, 4, 'Single Day Pass', 40.00, '2023-05-24', 'Vlad', 'Credit Card'),
    (4, 1, 'Early Bird', 100.00, '2018-04-21', 'Alex', 'Cash'),
    (5, 2, 'Early Bird', 250.00, '2021-08-01', 'Victor', 'PayPal'),
    (6, 2, 'General Access', 350.00, '2022-01-05', 'Radu', 'Credit Card'),
    (7, 1, 'VIP Access', 170.00, '2017-09-01', 'Cristi', 'PayPal'),
    (8, 3, 'Early Bird', 230.00, '2022-08-08', 'Robert', 'Cash');
