...
(
    ...
    constraint tickets_festivals_id_fk
        foreign key (festivalId) references festivals (id),
    constraint tickets_paymentMethods_id_fk
        foreign key (paymentMethodId) references paymentMethods (id),
    constraint tickets_ticketTypes_id_fk
...
create table `music-festivals`.festivalsTicketsPrices
(
    festivalId   int not null,
    ticketTypeId int not null,
    price        int not null,
    primary key (festivalId, ticketTypeId),
    constraint festivalsTicketsPrices_festivals_id_fk
        foreign key (festivalId) references festivals (id),
    constraint festivalsTicketsPrices_ticketTypes_id_fk
