                              ...
                              <View>
                                ...
                                <Dropdown
                                    ...
                                    data={[
                                        ...
                                        { label: i18n.t("radius.5000"), value: 5000 },
                                        // { label: i18n.t("radius.custom"), value: "custom" },
                                    ]}
                                    value={radius}
                                    onSelect={(value) => {
                                ...
                                {/*        onChangeText={(text) => setCustomRadiusValue(text)}*/}
                                {/*        onEndEditing={() => {*/}
                                {/*            const customValue = parseInt(customRadiusValue, 10);*/}
                                {/*            if (!isNaN(customValue)) {*/}
                                {/*                setRadius(customValue);*/}
                                {/*                onChangeRadius(customValue);*/}
                                {/*                setIsCustomRadius(false);*/}
